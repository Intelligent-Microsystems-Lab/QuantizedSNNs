...
if file_to_continue is not None:
    ...
    layer1.sign_random_readout.weights.data = restore_data['layer1'][4].to(device)
    layer1.sign_random_readout.weight_fa.data = restore_data['layer1'][5].to(device)
    ...
    layer1.inp_mult_q = layer1.tau_syn.to(device)
    layer1.inp_mult_p = layer1.tau_mem.to(device)
    ...
    layer2.sign_random_readout.weights.data = restore_data['layer2'][4].to(device)
    layer2.sign_random_readout.weight_fa.data = restore_data['layer2'][5].to(device)
    ...
    layer2.inp_mult_q = layer2.tau_syn.to(device)
    layer2.inp_mult_p = layer2.tau_mem.to(device)
    ...
    layer3.sign_random_readout.weights.data = restore_data['layer3'][4].to(device)
    layer3.sign_random_readout.weight_fa.data = restore_data['layer3'][5].to(device)
