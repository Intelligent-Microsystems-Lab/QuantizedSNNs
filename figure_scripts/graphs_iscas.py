...
axes[0].plot(np.arange(2,13,1), ds1_forward,  linewidth=2.5, label="Crossbar", color=crossbar_color)
axes[0].plot(np.arange(2,13,1), ds2_forward,  linewidth=2.5, label="PB-BMP", color=pb_bmp_color)
axes[0].plot(np.arange(2,13,1), ds3_forward, linewidth=2.5, label="PB-CSR", color=pb_csr_color)
...
axes[1].plot(np.arange(2,13,1), ds1_backward, linewidth=2.5, label="Crossbar", color=crossbar_color)
axes[1].plot(np.arange(2,13,1), ds2_backward, linewidth=2.5, label="PB-BMP", color=pb_bmp_color)
axes[1].plot(np.arange(2,13,1),ds3_backward, linewidth=2.5, label="PB-CSR", color=pb_csr_color)
...
#axes[0].get_yaxis().get_major_formatter().set_useOffset(False)
#axes[0].ticklabel_format(axis='y', style='sci')
axes[0].plot(np.arange(2,13,1), ds1_forward,  linewidth=2.5, label="Func-RowCol", color=func_rowcol_color)
axes[0].plot(np.arange(2,13,1), ds2_forward,  linewidth=2.5, label="PB-BMP", color=pb_bmp_color)
axes[0].plot(np.arange(2,13,1), ds3_forward, linewidth=2.5, label="PB-CSR", color=pb_csr_color)
...
#axes[1].ticklabel_format(axis='y', style='sci')
axes[1].plot(np.arange(2,13,1), ds1_backward, linewidth=2.5, label="Func-RowCol", color=func_rowcol_color)
axes[1].plot(np.arange(2,13,1), ds2_backward, linewidth=2.5, label="PB-BMP", color=pb_bmp_color)
axes[1].plot(np.arange(2,13,1), ds3_backward, linewidth=2.5, label="PB-CSR", color=pb_csr_color)
