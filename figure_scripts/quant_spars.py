...
global_wb_list = [2,3,4,5,6] #that what we should use!!!
...
# 		with open("/Users/clemens/mnt/crc/QuantizedSNN/results/snn_smile_precise_"+str(w_c)+str(a_c)+"8"+str(a_c)+"_1.0.pkl", 'rb') as f:
...
# 		with open("/Users/clemens/mnt/crc/QuantizedSNN/results/snn_smile_precise_"+str(w_c)+str(12)+str(g_c)+str(12)+"_1.0.pkl", 'rb') as f:
# 			results = pickle.load(f)
# 		qw1 = quant_w(results['w1'], w_c, scale1[w_c])
# 		qw2 = quant_w(results['w2'], w_c, scale1[w_c])
# 		x1 = torch.sum(qw1 != 0).float()/(qw1.shape[0] * qw1.shape[1])
...
data = pd.read_csv('/Users/clemens/Desktop/frontier.csv')
