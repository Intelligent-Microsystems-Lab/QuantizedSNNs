...
ap.add_argument("-t", "--t", type = int, help="trial number")
...
results = {'bit_string': bit_string ,'loss_hist': loss_hist, 'output': output.cpu(), 'lr':quantization.global_lr, 'w1':spytorch_util.w1.data.cpu(), 'w2':spytorch_util.w2.data.cpu()}
